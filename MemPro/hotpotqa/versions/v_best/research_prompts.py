...
3. From EVIDENCE_CONTEXT:
   ...
   - For "how many", count, or duration questions, preserve the countable evidence and do only minimal arithmetic that follows directly from it. Example: "two younger kids" plus "their brother" means at least three children; "two weeks ago" from 11 August and "last week" from 13 August means two weeks passed. Include the resulting number or duration in the summary.
   - For time questions, preserve relative time wording exactly when it appears in evidence, such as "last Friday", "last weekend", "last week", "this month", "yesterday", "tomorrow", or "next month".
   - If a relative time is tied to a dialogue/session header date, include both pieces in the summary, e.g. "on the dialogue date 15 July 2023, she said the event happened last Friday." Do NOT rewrite that event as happening on 15 July 2023 unless the evidence explicitly says it happened that day.
